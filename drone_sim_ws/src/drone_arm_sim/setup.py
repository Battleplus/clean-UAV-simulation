...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "cartesian_arm_velocity_control = drone_arm_sim.cartesian_velocity_control:main",
            "cartesian_arm_velocity_keyboard = drone_arm_sim.cartesian_velocity_keyboard:main",
            "acceptance_telemetry_recorder = drone_arm_sim.acceptance_telemetry_recorder:main",
            ...
            "gripper_demo = drone_arm_sim.gripper_demo:main",
            ...
            "rule_supervisor = drone_arm_sim.rule_supervisor:main",
